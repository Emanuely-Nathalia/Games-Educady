...
if(vez==1){
document.getElementById("img"+casa).src="img/image-removebg-preview (9).png"; //se o jogador for -1, coloca o desenho da bola
}else{
document.getElementById("img"+casa).src="img/image-removebg-preview (10).png";
} 
